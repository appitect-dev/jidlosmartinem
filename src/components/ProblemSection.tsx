      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        <div className="text-center space-y-12">
          ...
          <div className="grid md:grid-cols-1 gap-6 max-w-3xl mx-auto">
            <div className="bg-white rounded-xl p-6 shadow-sm border-l-4 border-red-400 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-center space-x-4">
                <div className="w-10 h-10 bg-red-100 rounded-full flex items-center justify-center flex-shrink-0">
                  <Zap className="w-5 h-5 text-red-600" />
                </div>
                <p className="text-lg text-gray-700 text-center">
                  <strong className="text-red-700">Máte práci, rodinu, povinnosti</strong> a už nezbývá energie řešit složité diety.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border-l-4 border-red-400 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-center space-x-4">
                ...
                <p className="text-lg text-gray-700 text-center">
                  Už jste <strong className="text-red-700">vyzkoušeli počítání kalorií nebo populární diety</strong>, ale nikdy to dlouho nevydrželo.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-8 border border-green-200">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-700">
                <strong className="text-green-700">Pravda je, že zhubnout jde i jinak.</strong> Potřebujete jen strategii, která respektuje váš životní rytmus – a <span className="bg-green-100 text-green-800 px-2 py-1 rounded font-semibold">přesně na to se specializuji</span>.
              </p>
