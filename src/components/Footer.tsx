                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-wrap gap-3 pt-4">
                            <div
                                className="flex items-center space-x-2 px-3 py-2 bg-green-100 rounded-lg border border-green-200">
                <span className="text-xs font-bold text-green-700">
                  ✓ Certifikovaný
                </span>
                            </div>
                            <div
                                className="flex items-center space-x-2 px-3 py-2 bg-yellow-100 rounded-lg border border-yellow-200">
                <span className="text-xs font-bold text-yellow-700">
                  ⭐ 150+ klientů
                </span>
                            </div>
                            <div
                                className="flex items-center space-x-2 px-3 py-2 bg-blue-100 rounded-lg border border-blue-200">
