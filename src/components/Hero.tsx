        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 max-w-3xl mx-auto mb-8">
            <p className="text-xl text-gray-700 leading-relaxed">
              👉 <em>Rezervujte si svou <span className="bg-green-100 text-green-800 px-2 py-1 rounded font-semibold">konzultaci zdarma</span> a zjistěte, jak může vypadat váš <strong>30denní plán na míru</strong>.</em>
            </p>
          </div>
