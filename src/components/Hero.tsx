          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl lg:text-6xl font-black text-gray-900 leading-tight mb-8">
                ...
                <span className="underline decoration-yellow-400 decoration-4">
                  práci, rodinu a minimum času
                </span>
              </h1>

              <div className="flex justify-center lg:justify-start flex-wrap gap-2 md:gap-4 mb-12">
                <div className="flex items-center bg-white px-2 md:px-4 py-2 rounded-full shadow-sm border border-gray-200 text-xs md:text-base whitespace-nowrap">
            ...
            <div className="relative">
              <div className="relative overflow-hidden rounded-3xl shadow-2xl">
                <Image
                  src="/hero.jpg"
                  alt="Zdravé hubnutí s výživovou poradkyní"
                  width={600}
                  height={700}
